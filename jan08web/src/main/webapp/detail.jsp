...
<body>
		...
		<div class="main">
			<div class="mainStyle">
				<article>
						...
						<div class="detailWRITECOUNT">
							<div class="detailWRITE">
								...
								<c:if
									...
									<img alt="삭제" src="./img/del.png" onclick="del()">
					...
					<button class="xi-reply">댓글쓰기</button>
	...
	<script type="text/javascript">
		function del(){
			...
			if(ch){location.href="./delete?no=${detail.no }";}
		}
		function update(){
			if(confirm("수정하시겠습니까?")){location.href="./update?no=${detail.no }";}
		}
		/* function commentDel(cno){
			if(confirm("댓글을 삭제하시겠습니까?")){location.href='./commentDel?no=${detail.no}&cno='+cno;}
		} */
	</script>
</body>
</html>