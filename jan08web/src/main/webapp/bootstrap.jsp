...
<html lang="en">
    ...
    <body id="page-top">
		...
		<div class="mx-5 p-5 border-top border-bottom border-success">
		...
		<div class="container bg-info text-white">
			...
			<div class="mx-2 my-4 py-5 bg-secondary">구역 3</div>
			<div class="my-2 bg-secondary w-25">구역 4</div>
			<div class="my-2 bg-secondary w-50">구역 5</div>
			<div class="my-2 bg-secondary w-75">구역 6</div>
			<div class="my-2 bg-secondary w-100">구역 7</div>
		</div>
